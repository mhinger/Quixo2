default_container {
  ...
  main_container {
    ...
    buffer2
    check_box_label :id => "human_label", :text => "Human Opponenet? ", :left_padding => 85
    unchecked :id => 'unchecked', :players => "human_opponent", :float => 'on', :x => 245, :y => 46
    checked :id => 'checked', :players => "human_opponent", :float => 'on', :x => 245, :y => 44
    buffer6
    input_container {
    ...
    buffer2 
    check_box_label :id => "check_box", :text => "Speed Game? ", :left_padding => 85
    unchecked :id => 'unchecked_timer', :players => "timer_check", :float => 'on', :x => 195, :y => 118
    checked :id => 'checked_timer', :players => "timer_check", :float => 'on', :x => 195, :y => 116    
    buffer6
