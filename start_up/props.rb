default_container {
  ...
  main_container {
    input_container {
      player_label :text => "Player 1 Name: ", :players => "player_type", :on_mouse_clicked => "puts 'I was clicked'"
      input :id => "player1", :players => 'text_box', :text => "Matt", :width => 130
    }
    buffer2
    input_container {
      player_label :text => "Player 2 Name: ", :players => "player_type", :on_mouse_clicked => "puts 'I also was clicked'"
      input :id => "player2", :players => 'text_box', :text => "John", :width => 130
    }
    buffer2
    input_container {
      time_label :text => "Length of Game: (In Minutes)"
      input :id => "game_length", :players => 'text_box', :text => "4", :width => 130
    }
    buffer2
    buffer3
